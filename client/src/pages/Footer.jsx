		...
		<div>
			<div className='flex flex-col lg:flex-row bg-gray-900 lg:h-60'>
				<div className='lg:w-1/2 ml-5 lg:ml-12 mt-5 lg:mt-10'>
					<p className='text-white text-2xl font-bold mb-3'>SportBooking.com</p>
					<p className='text-white mb-5 w-96 lg:w-1/2 text-justify'>SportBooking.com is an app where you can book grounds to play sports with your friends and loved ones. Book a ground near you today! </p>
				</div>
				<div className='lg:w-1/4 mx-5 lg:ml-48 mt-5 lg:mt-10'>
					<p className='text-white text-lg font-bold mb-3'>Contact</p>
					<p className='text-white'>Email: <span className='text-blue-200 hover:text-blue-400 cursor-pointer'>Lucifer@gamil.com</span></p>
				</div>
			...
			<div className='bg-gray-950 py-4 flex flex-col lg:flex-row items-center justify-between border-t border-gray-400'>
				<p className='text-white font-semibold lg:ml-10'> &#169; Lucifer, Inc.</p>
